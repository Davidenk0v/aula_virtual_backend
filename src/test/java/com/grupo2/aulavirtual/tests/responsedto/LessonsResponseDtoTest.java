...
class LessonsResponseDtoTest {
    ...
    void testGettersAndSetters() {
        ...
        assertEquals("Introduction to Programming", lessonsResponseDto.getName(),
                "Name getter must be equal to 'Introduction to Programming'");
        lessonsResponseDto.setName("Advanced Programming");
        assertEquals("Advanced Programming", lessonsResponseDto.getName(),
                "Name setter must be equal to 'Advanced Programming'");

        assertEquals("Lesson content", lessonsResponseDto.getContenido(),
                "Contenido getter must be equal to 'Lesson content'");
        lessonsResponseDto.setContenido("Advanced lesson content");
        assertEquals("Advanced lesson content", lessonsResponseDto.getContenido(),
                "Contenido setter must be equal to 'Advanced lesson content'");

        assertEquals("Description of the lesson", lessonsResponseDto.getDescription(),
                "Description getter must be equal to 'Description of the lesson'");
        lessonsResponseDto.setDescription("Advanced description");
        assertEquals("Advanced description", lessonsResponseDto.getDescription(),
                "Description setter must be equal to 'Advanced description'");
