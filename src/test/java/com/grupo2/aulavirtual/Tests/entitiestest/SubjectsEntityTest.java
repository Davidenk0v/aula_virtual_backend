...
class SubjectsEntityTest {
    ...
    void testGettersAndSetters() {
        ...
        assertEquals("Mathematics subject", subjectsEntity.getDescription(), "Description getter must be equal to 'Mathematics subject'");
        subjectsEntity.setDescription("Science subject");
        assertEquals("Science subject", subjectsEntity.getDescription(), "Description setter must be equal to 'Science subject'");
